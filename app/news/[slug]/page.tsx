  ...
  return (
    <>
      ...
      <div className="border-b border-border bg-card/60 pt-20">
        <div className="mx-auto flex max-w-4xl items-center gap-2 px-4 py-3 text-sm text-muted-foreground sm:px-6 lg:px-8">
      ...
      <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <Reveal>
          ...
          <h1 className="mt-5 font-display text-3xl font-bold tracking-tight text-primary text-balance sm:text-4xl">
            {article.title}
          </h1>
        ...
        {/* Article body */}
        <Reveal delay={80}>
          <div className="prose prose-slate mt-10 max-w-none text-foreground/85 [&_p]:leading-relaxed [&_p]:text-base">
            {article.body.split('\n\n').map((para, i) => (
              <p key={i} className="mt-5 text-base leading-relaxed text-foreground/85 first:mt-0">
                {para}
              </p>
            ))}
          </div>
        ...
        <div className="mt-12 border-t border-border pt-8">
          <Link
            href="/news"
            className="inline-flex items-center gap-2 rounded-md border border-border bg-card px-5 py-3 text-sm font-semibold text-foreground transition-colors hover:border-primary/40 hover:bg-secondary hover:text-primary"
          >
                ...
                <Reveal key={rel.slug} delay={i * 80}>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium text-accent">{rel.category}</p>
