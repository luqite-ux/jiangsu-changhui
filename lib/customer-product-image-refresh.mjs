...
export const CUSTOMER_REFRESH_R2_PREFIX = 'v0-design-assets/jiangsu-changhui/customer-product-refresh-2026-08/'
export const CUSTOMER_REFRESH_PUBLIC_BASE = 'https://pub-c7a22068052144a5805830c30d280128.r2.dev/'
...
export function customerRefreshPublicUrl(sourceId) {
  const source = sourceById[sourceId]
  if (!source || source.reviewStatus !== 'publish') throw new Error(`Source is not approved for publication: ${sourceId}`)
  return `${CUSTOMER_REFRESH_PUBLIC_BASE}${CUSTOMER_REFRESH_R2_PREFIX}${sourceId}.webp`
}
