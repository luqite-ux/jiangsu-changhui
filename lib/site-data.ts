...
export const products: Product[] = [
  ...
  { slug: 'hxgn-12', name: 'HXGN\u25a1-12 AC Metal-Enclosed Ring Main Unit', category: 'hv-switchgear', categoryName: 'High Voltage Switchgear', image: '/products/hv-switchgear.png', images: ['/products/hv-switchgear.png'], description: 'This model is included in the customer-supplied product list. Configuration, dimensions and technical performance are confirmed for each order from approved drawings and project requirements.', customNote: 'Please provide drawings, quantities and project requirements for engineering review and quotation.', applications: ['Made to drawings', 'Project-specific configuration'], relatedSlugs: ['kyn28-12', 'kyn61-40-5'] },
  // LV Switchgear (5)
  ...
  // Box Substation (1)
  { slug: 'box-substation', name: 'Box-Type Substation Series (European-Type)', category: 'box-substation', categoryName: 'Box-Type Substations', image: '/products/transformer.png', images: ['/products/transformer.png'], description: 'This model is included in the customer-supplied product list. Configuration, dimensions and technical performance are confirmed for each order from approved drawings and project requirements.', customNote: 'Please provide drawings, quantities and project requirements for engineering review and quotation.', applications: ['Made to drawings', 'Project-specific configuration'], relatedSlugs: ['kyn28-12', 'mns', 'ggd'] },
  // Busway (4)
...
The supplied materials state a total site area of 42,000 square meters and a building area of 25,000 square meters. Registered capital is RMB 30.05 million.
